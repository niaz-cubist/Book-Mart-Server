...
const uri = "mongodb+srv://geniuscar:geniuscar@cluster0.7grdyfl.mongodb.net/?retryWrites=true&w=majority";
...
app.listen(port, () => console.log(`BookMart portal is running on ${port}`))